...
const ChatRoom = () => {
  ...
  return (
    <div className="Chatroom">
        ...
        <div className="align-right">
                <Box display="inline-block">
                  <Flex alignItems="center">
                    <Image src={JSON.parse(localStorage.getItem('login-user')).profileImagePath} sx={{ borderRadius: '50%' }} width="50px" height="50px" />
      ...
      <div className="chat-logo-container"><img src={logo} className="logo-image-chatroom" alt="logo" /></div>
      ...
      <div className="chat-big-container">
        <div className="chat-message-container">
          {chatMessages.map((chatMessageData) => {
            ...
            <div className="chat-sent-by-me">&nbsp; <p10>나: </p10>{chatMessageData.message}</div> : 
            <div className="chat-sent-by-him">&nbsp;<p10>상대방: &nbsp; &nbsp; </p10> {chatMessageData.message}</div>)
          })}
        </div>
        <div className="chat-send-form">
          <form  onSubmit={onSendMessage}>
            <div className="chat-input">
              ...
              <input type="text" value={chatInput} onChange={onChatInputChange} placeholder="운명의 상대방에게 말을 걸어보세요" />
