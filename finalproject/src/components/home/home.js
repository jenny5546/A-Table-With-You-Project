        ...
        <div className="Login-Signup">
          <div className="Login" > 
            <input type="submit" onClick ={handleClickOpen_login} className="Login-button" value="로그인"/>
              ...
              <Dialog fullScreen open={open_login} onClose={handleClose_login} aria-labelledby="form-dialog-title">
                    ...
                    <form className="signup-form">
                      <div className="signup-title">Sign-up</div>
                        ...
                        <div className="signup-form">
                          ...
                          <div className = "input">
                            <TextField type="password" className="password" placeholder="6자 이상의 비밀번호"/>
                          </div>
